...
import {
  ...
  User, LayoutDashboard, Users, FileText, ListChecks, Trophy, Inbox, Activity, Copy, CalendarDays, FileWarning,
} from "lucide-react";
...
export type NavIcon =
  ...
  | "activities" | "duplicates" | "missing" | "wins" | "backlog" | "health" | "visits";
